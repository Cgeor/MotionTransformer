...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--total_output_n', type=int, default=30, help='total future frame number')
    ...
    def parse(self):
        ...
        if not self.opt.is_eval:
            ...
            base_name = self.opt.exp
            log_name = '{}_in{}_out{}_ks{}_dctn{}'.format(base_name, self.opt.input_n,
                                                          self.opt.output_n,
